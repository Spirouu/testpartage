...
set(handles.text10,'String',num2str(a,5));
set(handles.text14,'String',num2str(b1,5));
set(handles.text15,'String',num2str(DB11,5));

set(handles.text16,'String',num2str(b,5));
set(handles.text17,'String',num2str(b0,5));
set(handles.text18,'String',num2str(DB10,5));

set(handles.text19,'String',num2str(sigma,5));
set(handles.text20,'String',num2str(sigma_est,5));

set(handles.text21,'String',num2str(Rcarre,5));
set(handles.text22,'String',num2str(sqrt(Rcarre),5));
